%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%% FF-type motoneuron model with active dendrite %%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
close all
clear all
clc
...
%% Model Parameters
Irh = 21.3;                                                                %Rheobase Current [nA]
Ri = 70.0;                                                                 %Cytoplasm Resistivity [Ohm x cm]
Cm = 1.0;                                                                  %Membrane Specific Capacitance [uF/cm²]
Rm_d = 6500.0;                                                             %Dendritic Membrane Specific Resistance [Ohm x cm²]
Rm_s = 800.0;                                                              %Somatic Membrane Specific Resistance [Ohm x cm²]
ld = 9318.0;                                                               %Dendritic Length [um]
ls = 100;                                                                  %Somatic Length [um]
rd = (88.0)/2;                                                             %Dendritic Radius [um]
rs = (100.0)/2;                                                            %Somatic Radius [um]
...
GCa = 2*1e-5*pi*rd*ld*(0.012);                                             %Peak Conductance - L-type Calcium [uS]
...
GKf = 2*1e-5*pi*rs*ls*(0.5);                                               %Peak Conductance - Fast Potassium [uS] //MAX: 4.0
GKs = 2*1e-5*pi*rs*ls*(15.4);                                              %Peak Conductance - Slow Potassium [uS] //MAX: 19.15
...
% Excitatory
% te0 = 0.0;
% AFe = 10;                                                                  %Afferent Ia fibers //MAX: 54
...
%% ISI [ms]
% Excitatory
% lambda_exc = 600.0;                                                        %Pre-synaptic neurons firing rate [pps]
